  ...
  <!-- Main Container -->
          ...
          <div class="container">
            <div class="table-responsive">
                <div>
                    <div> 
                    <div id="side" class="buttons-set"><button class="button cybernetically"><a href="admin_buttons.php"><span style="color:#000;"> Admin </span></a></button>
