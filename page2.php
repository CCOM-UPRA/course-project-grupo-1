    ...
    <div class="container">
        ...
        <div class="mm-toggle-wrap">
          ...
          <ul class="nav hidden-xs menu-item menu-item-left">
            ...
            <li class="level0 parent drop-menu"><a href="#"><span>Trailers</span> </a>
            </li>
            ...
            <li class="mega-menu"><a href="grid.php" class="level-top"><span>Series</span></a>
              <div style="left: 0px; display: none;" class="level0-wrapper dropdown-6col">
                <div class="container">
                  <div class="level0-wrapper2">
                    <div class="nav-block nav-block-center">
            ...
            <li class="mega-menu"><a class="level-top" href="grid.php"><span>Free</span></a>
