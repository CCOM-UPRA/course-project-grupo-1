    ...
    <div class="row">
      <div class="col-main col-sm-9 col-sm-push-3">
        ...
        <article class="col-main">
          ...
          <li class="item odd">
            <div class="product-image"> <a href="#/30-flat-panel-tft-lcd-cinema-hd-monitor.php" title="Avengers Age of Ultron"> <img class="small-image" src="newImages/Movies/movies/ultron.jpg" alt="Avengers Age of Ultron" title="Avengers Age of Ultron"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="#/30-flat-panel-tft-lcd-cinema-hd-monitor.php" title="Avengers Age of Ultron">Avengers Age of Ultron</a></h2>
              <div class="desc std">
          ...
          <li class="item even">
            <div class="product-image"> <a href="#/19-widescreen-flat-panel-lcd-monitor.php" title="Star Wars The RIse of the Skywalker"> <img class="small-image" src="newImages/Movies/movies/starwars.jpg" alt="Star Wars The RIse of the Skywalker" title="Star Wars The RIse of the Skywalker"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="#/19-widescreen-flat-panel-lcd-monitor.php" title="Star Wars The RIse of the Skywalker">Star Wars Rise of the Skywalker</a></h2>
              <div class="desc std">
          ...
          <li class="item odd">
            <div class="product-image"> <a href="#/250gb-5400rpm.php" title="Jumanji"> <img class="small-image" src="newImages/Movies/movies/Jumanji.jpg" alt="Jumanji" title="Jumanji"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="#/250gb-5400rpm.php" title="Jumanji">Jumanji </a></h2>
              <div class="desc std">
                <p>When Spencer goes back into the fantastical world of Jumanji, pals Martha, Fridge and Bethany re-enter the game to bring him home. But the game is now broken -- and fighting back. Everything the friends know about Jumanji is about to change, as they soon discover there's more obstacles and more danger to overcome.</p>
                            </div>
          ...
          <li class="item even">
            <div class="product-image"> <a href="#/500gb-5400rpm.php" title="Wonder Woman"> <img class="small-image" src="newImages/Movies/movies/wonder.jpg" alt="Wonder Woman" title="Wonder Woman"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="#/500gb-5400rpm.php" title="Wonder Woman">Wonder Woman</a></h2>
              <div class="desc std">
                <p>Diana Prince lives quietly among mortals in the vibrant, sleek 1980s -- an era of excess driven by the pursuit of having it all. Though she's come into her full powers, she maintains a low profile by curating ancient artifacts, and only performing heroic acts incognito. But soon, Diana will have to muster all of her strength, wisdom and courage as she finds herself squaring off against Maxwell Lord and the Cheetah, a villainess who possesses superhuman strength and agility.</p>       
                     </div>
              <div class="price-box"> <span class="regular-price"> <span class="price">$19.99</span> </span> </div>
              <div class="actions">
                <button class="button btn-cart ajx-cart" title="Add to Cart" type="button"><span>Add to Cart</span></button>
          ...
          <li class="item odd">
            <div class="product-image"> <a href="#" title="Justice League"> <img class="small-image" src="newImages/Movies/movies/justic.jpg" alt="Justice League" title="Justice League"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="#" title="Justice League">Justice League</a></h2>
              <div class="desc std">
          ...
          <li class="item even">
            <div class="product-image"> <a href="#/24-widescreen-flat-panel-lcd-monitor.php" title="Joker"> <img class="small-image" src="newImages/Movies/movies/joker.jpg" alt="Joker" title="Joker"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="#/24-widescreen-flat-panel-lcd-monitor.php" title="Joker">Joker</a></h2>
              <div class="desc std">
          ...
          <li class="item odd">
            <div class="product-image"> <a href="#/microsoft-wireless-optical-mouse-5004.php" title="Sonic The Hedgehog"> <img class="small-image" src="newImages/Movies/movies/sonic.jpeg" alt="Sonic The Hedgehog" title="Sonic The Hedgehog"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="#/microsoft-wireless-optical-mouse-5004.php" title="Sonic The Hedgehog">Sonic The Hedgehog</a></h2>
              <div class="desc std">
                <p>The world needed a hero -- it got a hedgehog. Powered with incredible speed, Sonic embraces his new home on Earth -- until he accidentally knocks out the power grid, sparking the attention of uncool evil genius Dr. Robotnik. Now, it's supervillain vs. supersonic in an all-out race across the globe to stop Robotnik from using Sonic's unique power to achieve world domination.</p>
                            </div>
