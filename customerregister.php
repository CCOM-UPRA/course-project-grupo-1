...
if($password==$password2)
{
    ...
    $sql2 ="INSERT INTO address(address_id, street1,street2,postal_code,city) VALUES('$address','$PO_box','$state','$country','$zip') FROM user WHERE usingID.address = usingID.user ";
    $connect->query($sql2);
