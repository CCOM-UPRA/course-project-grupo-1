...
<div id="page"> 
  ...
  <nav>
    <div class="container">
          <!-- Header Logo -->
          <div class="logo"><a title="Prism" href="index.php"><img alt="Prism" src="newImages/HomeImages/PageIcon/LogoPrincipal2.png"></a></div>
          <!-- End Header Logo --> 
        ...
        <div class="mm-toggle-wrap">
          ...
          <ul class="nav hidden-xs menu-item menu-item-left">
            ...
            <li class="level0 parent drop-menu active" class="mega-menu"><a class="level-top" href="sales_grid.php"><span>Sales</span></a>
      ...
      <div class="row">
        <div class="col-main col-sm-9 col-sm-push-3">
                ...
                <div class="slider-items slider-width-col1 owl-carousel owl-theme"> 
                  ...
                  <div class="item"> <a href="#"><img alt="" src="newImages/Movies/movies/popular.png"></a>
                    <div class="cat-img-title cat-bg cat-box">
                      ...
                      <h2 class="cat-heading">Movie On Sales!</h2>
                      <p>Here you can find the bests movies with discounts on the market. </p>
                    </div>
                  </div>
                  <!-- End Item --> 
          ...
          <article class="col-main">
            ...
            <div class="toolbar">
              <div class="sorter">
                <div class="view-mode"> <span title="List" class="button button-active button-grid">&nbsp;</span><a href="sales_list.php" title="List" class="button-list">&nbsp;</a> </div>
              </div>
              <div id="sort-by">
              ...
              <ul class="products-grid">
                <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"><a href="#" title=" Hunger Games" class="product-image"><img src="newImages/Movies/movies/Hunger_Games.png" alt="Hunger Games" title="Hunger Games"></a>
                    ...
                    <div class="item-info">
                      <div class="info-inner">
                        <div class="item-title"><a href="#" title="Hunger Games">Hunger Games</a> </div>
                        <div class="item-content">
                          <div class="item-price">
                            <div class="price-box"><div  class="price-box"><span class="price">2.99<p class="old-price"><span class="price-label"></span><span class="price">$19.99</span> </span> </div>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"><a href="#" title="If I Stay" class="product-image"><img src="newImages/Movies/movies/If_I_Stay.png" alt="If I Stay" title="If I Stay"></a>
                        <div class="actions">
                          <!-- <div class="quick-view-btn"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Quick View"> <span>Quick View</span></a></div> -->
                          <!-- <div class="link-wishlist"><a href="wishlist.php" data-toggle="tooltip" data-placement="right" title="" data-original-title="Wishlist"><span>Add to Wishlist</span></a></div> -->
                          <div class="link-compare"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Watch Trailer"><span>Watch Trailer</span></a></div>
                    ...
                    <div class="item-info">
                      <div class="info-inner">
                        <div class="item-title"><a href="#" title="If I Stay">If I Stay</a> </div>
                        <div class="item-content">
                          <div class="item-price">
                            <div class="price-box"><div  class="price-box"><span class="price">4.99<p class="old-price"><span class="price-label"></span><span class="price">$19.99</span> </span> </div>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"><a href="#" title="Me Before You" class="Me Before You"><img src="newImages/Movies/movies/Me before You.png" alt="Me before You" title="Me Before You"></a>
                        <div class="actions">
                          <!-- <div class="quick-view-btn"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Quick View"> <span>Quick View</span></a></div> -->
                          <!-- <div class="link-wishlist"><a href="wishlist.php" data-toggle="tooltip" data-placement="right" title="" data-original-title="Wishlist"><span>Add to Wishlist</span></a></div> -->
                          <div class="link-compare"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Watch Trailer"><span>Watch Trailer</span></a></div>
                    ...
                    <div class="item-info">
                      <div class="info-inner">
                        <div class="item-title"><a href="#" title="Me Before You">Me Before You</a> </div>
                        <div class="item-content">
                          <div class="item-price">
                            <div class="price-box"><div  class="price-box"><span class="price">1.99<p class="old-price"><span class="price-label"></span><span class="price">$19.99</span> </span> </div>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"><a href="#" title="Paper_Towns" class="product-image"><img src="newImages/Movies/movies/Paper_Towns.png" alt="Paper Towns" title="Paper Towns"></a>
                        <div class="actions">
                          <!-- <div class="quick-view-btn"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Quick View"> <span>Quick View</span></a></div> -->
                          <!-- <div class="link-wishlist"><a href="wishlist.php" data-toggle="tooltip" data-placement="right" title="" data-original-title="Wishlist"><span>Add to Wishlist</span></a></div> -->
                          <div class="link-compare"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Watch Trailer"><span>Watch Trailer</span></a></div>
                    ...
                    <div class="item-info">
                      <div class="info-inner">
                        <div class="item-title"><a href="unnamed.png" title="Paper Towns">Paper Towns</a> </div>
                        <div class="item-content">
                          <div class="item-price">
                            <div class="price-box"><div  class="price-box"><span class="price">4.99<p class="old-price"><span class="price-label"></span><span class="price">$19.99</span> </span> </div>
                          </div>
                ...
                <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"><a href="#" title="The_Fault_In_Our_Stars" class="product-image"><img src="newImages/Movies/movies/The_Fault_In_Our_Stars.png" alt="The_Fault_In_Our_Stars" title="The Fault In Our Stars"></a>
                        <div class="actions">
                          <!-- <div class="quick-view-btn"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Quick View"> <span>Quick View</span></a></div> -->
                          <!-- <div class="link-wishlist"><a href="wishlist.php" data-toggle="tooltip" data-placement="right" title="" data-original-title="Wishlist"><span>Add to Wishlist</span></a></div> -->
                          <div class="link-compare"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Watch Trailer"><span>Watch Trailer</span></a></div>
                    ...
                    <div class="item-info">
                      <div class="info-inner">
                        <div class="item-title"><a href="#" title="The Fault In Our Stars">The The Fault In Our Stars</a> </div>
                        <div class="item-content">
                          <div class="item-price">
                            <div class="price-box"><div  class="price-box"><span class="price">4.99<p class="old-price"><span class="price-label"></span><span class="price">$19.99</span> </span> </div>
                          </div>
                ...
                <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"><a href="#" title="Hobbs & Shaw" class="product-image"><img src="newImages/Movies/movies/Hobbs & Shaw.png" alt="Hobbs & Shaw" title="Hobbs & Shaw"></a>
                        <div class="actions">
                          <!-- <div class="quick-view-btn"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Quick View"> <span>Quick View</span></a></div> -->
                          <!-- <div class="link-wishlist"><a href="wishlist.php" data-toggle="tooltip" data-placement="right" title="" data-original-title="Wishlist"><span>Add to Wishlist</span></a></div> -->
                          <div class="link-compare"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Watch Trailer"><span>Watch Trailer</span></a></div>
                    ...
                    <div class="item-info">
                      <div class="info-inner">
                        <div class="item-title"><a href="#" title="Hobbs & Shaw">Hobbs & Shaw</a> </div>
                        <div class="item-content">
                        <div class="item-price"> <div  class="price-box"><span class="price">4.99<p class="old-price"><span class="price-label"></span><span class="price">$19.99</span> </span> </div>
                        <div  class="price-box"><span class="price"><p class="old-price"><span class="price-label"></span><span class="price"></span> </span> </div>   
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"><a href="#" title="Maze_Runner_Death_Cure" class="product-image"><img src="newImages/Movies/movies/Maze_Runner_Death_Cure.png" alt="Maze_Runner_Death_Cure" title="Maze Runner Death Cure"></a>
                        <div class="actions">
                          <!-- <div class="quick-view-btn"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Quick View"> <span>Quick View</span></a></div> -->
                          <!-- <div class="link-wishlist"><a href="wishlist.php" data-toggle="tooltip" data-placement="right" title="" data-original-title="Wishlist"><span>Add to Wishlist</span></a></div> -->
                          <div class="link-compare"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Watch Trailer"><span>Watch Trailer</span></a></div>
                    ...
                    <div class="item-info">
                      <div class="info-inner">
                        <div class="item-title"><a href="#" title="Maze Runner Death Cure">Maze Runner Death Cure</a> </div>
                        <div class="item-content">
                          <div class="item-price">
                            <div class="price-box"><span class="price">$4.99</span> </span><p class="old-price"> <span class="price-label"></span> <span class="price"> $19.99 </span> </p> </div>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"><a href="#" title="Joker" class="product-image"><img src="newImages/Movies/movies/Ferdinand.png" alt="Ferdinand" title="Ferdinand"></a>
                        <div class="actions">
                          <!-- <div class="quick-view-btn"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Quick View"> <span>Quick View</span></a></div> -->
                          <!-- <div class="link-wishlist"><a href="wishlist.php" data-toggle="tooltip" data-placement="right" title="" data-original-title="Wishlist"><span>Add to Wishlist</span></a></div> -->
                          <div class="link-compare"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Watch Trailer"><span>Watch Trailer</span></a></div>
                    ...
                    <div class="item-info">
                      <div class="info-inner">
                        <div class="item-title"><a href="#" title="Ferdinand">Ferdinand</a> </div>
                        <div class="item-content">
                          <div class="item-price">
                            <div class="price-box"><span class="price">$4.99</span> </span><p class="old-price"> <span class="price-label"></span> <span class="price"> $19.99 </span> </p> </div>
                          </div>
                ...
                <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"><a href="#" title="Treasure_Planet2" class="product-image"><img src="newImages/Movies/movies/Treasure_Planet2.png" alt="Treasure_Planet2" title="Treasure Planet"></a>
                        <div class="new-label new-top-left">New</div>
                        <div class="actions">
                          <!-- <div class="quick-view-btn"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Quick View"> <span>Quick View</span></a></div> -->
                          <!-- <div class="link-wishlist"><a href="wishlist.php" data-toggle="tooltip" data-placement="right" title="" data-original-title="Wishlist"><span>Add to Wishlist</span></a></div> -->
                    ...
                    <div class="item-info">
                      <div class="info-inner">
                        <div class="item-title"><a href="#" title="Treasure Planet">Treasure Planet</a> </div>
                        <div class="item-content">
                          <div class="item-price">
                            <div class="price-box"><span class="price">$4.99</span> </span><p class="old-price"> <span class="price-label"></span> <span class="price"> $19.99 </span> </p> </div>
                          </div>
                ...
                <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"><a href="#" title="2Fast 2Furious" class="product-image"><img src="newImages/Movies/movies/Fast_Furios_2.png" alt="Fast_Furious_2" title="Fast Furious 2"></a>
                        <div class="new-label new-top-left">New</div>
                        <div class="actions">
                          <!-- <div class="quick-view-btn"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Quick View"> <span>Quick View</span></a></div> -->
                          <!-- <div class="link-wishlist"><a href="wishlist.php" data-toggle="tooltip" data-placement="right" title="" data-original-title="Wishlist"><span>Add to Wishlist</span></a></div> -->
                    ...
                    <div class="item-info">
                      <div class="info-inner">
                        <div class="item-title"><a href="#" title="2Fast and Furious 2">2Fast 2Furious </a> </div>
                        <div class="item-content">
                          <div class="item-price">
                            <div class="price-box"><span class="price">$4.99</span> </span><p class="old-price"> <span class="price-label"></span> <span class="price"> $19.99 </span> </p> </div>
                          </div>
                ...
                <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"><a href="#" title="Cars_1" class="product-image"><img src="newImages/Movies/movies/Cars_1.png" alt="Cars 1" title="Cars "></a>
                         <div class="actions">
                          <!-- <div class="quick-view-btn"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Quick View"> <span>Quick View</span></a></div> -->
                          <!-- <div class="link-wishlist"><a href="wishlist.php" data-toggle="tooltip" data-placement="right" title="" data-original-title="Wishlist"><span>Add to Wishlist</span></a></div> -->
                          <div class="link-compare"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Watch Trailer"><span>Watch Trailer</span></a></div>
                    ...
                    <div class="item-info">
                      <div class="info-inner">
                        <div class="item-title"><a href="#" title="Cars ">Cars</a> </div>
                        <div class="item-content">
                          <div class="item-price">
                            <div class="price-box"><span class="price">$4.99</span> </span><p class="old-price"> <span class="price-label"></span> <span class="price"> $19.99 </span> </p> </div>
                          </div>
                ...
                <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"><a href="#" title="Cars_2" class="product-image"><img src="newImages/Movies/movies/Cars_2.png" alt="Cars_2" title="Cars 2"></a>
                        <div class="actions">
                          <!-- <div class="quick-view-btn"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Quick View"> <span>Quick View</span></a></div> -->
                          <!-- <div class="link-wishlist"><a href="wishlist.php" data-toggle="tooltip" data-placement="right" title="" data-original-title="Wishlist"><span>Add to Wishlist</span></a></div> -->
                          <div class="link-compare"><a href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Watch Trailer"><span>Watch Trailer</span></a></div>
                    ...
                    <div class="item-info">
                      <div class="info-inner">
                        <div class="item-title"><a href="#" title="Cars 2">Cars 2</a> </div>
                        <div class="item-content">
                          <div class="item-price">
                            <div class="price-box"><span class="price">$2.99</span> </span><p class="old-price"> <span class="price-label"></span> <span class="price"> $19.99 </span> </p> </div>
                          </div>
                        </div>
                      </div>
                    </div>
  ...
  <ul>
    ...
    <li><a href="#">Pages</a>
      <ul>
        ...
        <li> <a href="sales_list.php">List</a> </li>
