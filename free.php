                                                ...
                                                <div class="item-img">
                                                  ...
                                                  <img class = "product-img" src="<?php echo $final['photo']?>" alt="<?php echo $final['product_name']?>" title="<?php echo $final['product_name']?>" class="product-image">
                                                    <div class="actions">
                                                      ...
                                                      <?php echo "<a href='free.php?cart_id={$final['product_id']} &cart_name={$final['product_name']} &cart_price={$final['price']}' class='popup-btn' data-toggle='tooltip' data-placement='right' type='button' data-original-title='Add to Cart'> <span>Quick View</span></a>"?>
                                                      </div>
                                                    </div>
