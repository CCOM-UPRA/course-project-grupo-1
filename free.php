...
<div id="page">
  ...
  <!-- Navbar -->
    ...
    <div class="container">
          <!-- Header Logo -->
          <div class="logo"><a title="Datson" href="index.php"><img alt="Prism" src="newImages/HomeImages/PageIcon/LogoPrincipal2.png"></a></div>
          <!-- End Header Logo -->
      ...
      <div class="row">
        <div class="col-main col-sm-9 col-sm-push-3">
          ...
          <article class="col-main">
            ...
            <div class="toolbar">
              <div class="sorter">
                <div class="view-mode"> <span title="Grid" class="button button-active button-grid">&nbsp;</span><a href="list_free.php" title="List" class="button-list">&nbsp;</a> </div>
              </div>
              <div id="sort-by">
              ...
              <div class="pager">
                ...
                <!-- <div class="pages">
                  ...
                  <ul class="pagination">
                    ...
                    <li class="active"><a href="grid.php">1</a></li>
              ...
              <ul class="products-grid">
                <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                  <div class="item-inner"> 
                    <div class="item-img"> 
                      <div class="item-img-info"><a href="#" title=" Iron Man 2" class="product-image"><img src="newImages/Free/ironMan2.png" alt="Iron Man 2" title="Iron Man 2"></a>
                    ...
                    <div class="item-info">
                      <div class="info-inner">
                        <div class="item-title"><a href="#" title="Avengers Endgame">Iron Man 2</a> </div>
