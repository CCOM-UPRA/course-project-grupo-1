    ...
    <div class="main container">
      <div class="account-login">
        <div class="page-title">
          <h1 id="new1">Admin Portafolio</h1>
        </div>
        <fieldset class="col2-set">
          <legend>Admin Portafolio</legend>
          <div class="col-1 new-users"><strong>Admin</strong>
            <div class="content"> 
              <div class="buttons-set">
                <button class="button cybernetically" style="width: 50%;"><a href="manage_user.php"><span style="color: #000;;">Management</span></a></button>
              </div>              <div class="buttons-set">
                <button class="button cybernetically" style="width: 50%;"><a href="manage_admin.php"><span style="color: #000;">Admin Management</span></a></button>
              </div>
              <div class="buttons-set">
                <button class="button cybernetically" style="width: 50%;"><a href="reports.php"><span style="color:#000;">Reports</span></a></button>
              </div>
              <div class="buttons-set">
                <button class="button cybernetically" style="width: 50%;"><a href="recibo.php"><span style="color:#000;">  Receipt</span></a></button>
              </div>
              <div class="buttons-set">
                <button class="button cybernetically" style="width: 50%;"><a href="#"><span style="color:#000;">LogOut</span></a></button>
              </div>
            </div>
          </div>
          <!--
  ...
  <ul>
    ...
    <li><a href="#">Pages</a>
      <ul>
        ...
        <li><a href="sales_list.php">Sales List</a></li><!-- Verify What Do on Login in Sales list Important!-->
