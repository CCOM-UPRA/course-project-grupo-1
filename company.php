      ...
      <div class="row">
        <section class="col-main col-sm-9">
          ...
          <div class="static-contain">
            <p style="font-size:medium">Prism is an e-commerce site focus on selling all types of movies and series. We want to give you an amazing experience while searching for your favorite’s movies or series. That is why we have a variety of sales in a lot of products, although we also have free products. For the customer to have an easy and friendly experience we recommend that the customer must create an account in Prism.</p>
        </br>  
        </div>
        </section>
          ...
          <div class="block block-company">
            ...
            <div class="block-content">
              <ol id="recently-viewed-items">
                <li class="item odd"><strong>Company</strong></li>
                <li class="item even"><a href="about_us.php">About us</a></li>
