...
<div id="page"> 
  ...
  <nav>
    <div class="container">
          <!-- Header Logo -->
          <div class="logo"><a title="Datson" href="index.php"><img alt="Datson" src="newImages/HomeImages/PageIcon/LogoPrincipal2.png"></a></div>
          <!-- End Header Logo --> 
  ...
  <!-- Main Container -->
          ...
          <div class="container">
            <div class="table-responsive">
                <div>
                    <div> 
                    <div id="side" class="buttons-set">
                        <button class="button cybernetically"><a href="reports.php"><span style="color:#000;">Order Report</span></a></button>
                        <button class="button cybernetically"><a href="#"><span style="color:#000;">Sales Report</span></a></button>
                        <button class="button cybernetically"><a href="inventory_report.php"><span style="color:#000;">Inventory Report</span></a></button>
                      </div> 
                    </div>
                    ...
                    <table class="table table-striped table-hover">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>$0.00</td>                     
                                <td>
                                    <a href="#" class="settings" title="Settings" data-toggle="tooltip"><i class="fa">&#xf055;</i></a>
                                    <a href="#" class="delete" title="Delete" data-toggle="tooltip"><i class="fa">&#xf05c;</i></a>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
