        ...
        <fieldset class="col2-set">
          ...
          <div class="container"> 
            <div class="table-responsive">
              <div> 
                <div id="side" class="buttons-set"><button class="button cybernetically"><a href="admin_buttons.php"><span style="color:#000;"> Add Admin </span></a></button>
                ...
                <div class="table-wrapper">
                    ...
                    <table class="table table-striped table-hover">
                        <thead>
                            ...
                            <tr>
                                <td>2</td>
                                <td>Cristopher Rosado</td>
                                <td>3/5/2021</td>
                                <td>cristopher@upr.edu</td>
                                <td>787-342-3521</td>                         
                                <td>Admin</td>
                                <td>
                                    <a href="#" class="settings" title="Settings" data-toggle="tooltip"><i class="material-icons">&#xE8B8;</i></a>
