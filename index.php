          ...
          <ul>
            ...
            <!-- LAYER NR. 1 
              ...
              <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0" 
									...
									style="z-index: 7; white-space: nowrap;">Mega Sales on Series </div>
            <!-- SLIDE  -->
        ...
        <div class="slider-items slider-width-col4 products-grid">
          <div class="item">
            <div class="item-inner">
              <div class="item-img">
                <div class="item-img-info"> <a class="product-image" title="Sonic The Hedgehog" href="#"> <img alt="Sonic The Hedgehog" src="newImages/HomeImages/secondSliderImages/sonicHedhog.jpeg"> </a>
                  <div class="actions">
