            ...
            <div class="block-icon pull-right"> <a data-target=".bs-example-modal-lg" data-toggle="modal" class="search-focus dropdown-toggle links"> <i class="fa fa-search"></i> </a>
              ...
              <div class="toplinks">
                <div class="links">
                  ...
                  <div class="demo"><a title="Admin" href="admin_buttons.php"><span class="hidden-xs">Admin</span></a></div>
                  <!-- Header Company -->
    ...
    <div class="container">
        ...
        <div class="mm-toggle-wrap">
          ...
          <ul class="nav hidden-xs menu-item menu-item-left">
            ...
            <li class="level0 parent drop-menu active" class="level0 nav-8 level-top"><a href="coming_soon.php" class="level-top"><span>Coming Soon</span></a></li>
    ...
    <div class="row">
      <div class="col-main col-sm-9 col-sm-push-3">
        ...
        <article class="col-main">
          ...
          <div class="toolbar">
            <div class="sorter">
                <div class="view-mode"> <a href="coming_soon.php" title="Grid" class="button button-grid">&nbsp;</a>&nbsp; <span title="List" class="button button-active button-list">&nbsp;</span>&nbsp; </div>
              </div>
            <div id="sort-by">
          ...
          <li class="item first">
            <div class="product-image"> <a href="#" title="Thor: Love and Thunder"> <img class="small-image" src="newImages/ComingSoon/loventhunder.jpg" alt="Thor: Love and Thunder" title="Thor: Love and Thunder"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="#/htc-rhyme-sense.php" title="Thor: Love and Thunder">Thor: Love and Thunder</a></h2>
             <!-- <div class="ratings">
          ...
          <li class="item even">
            <div class="product-image"> <a href="#" title="Black Widow"> <img class="small-image" src="newImages/ComingSoon/black_widow.jpg" alt="Black Widow" title="Black Widow"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="#" title="Black Widow">Black Widow</a></h2>
              <div class="desc std">
          ...
          <li class="item odd">
            <div class="product-image"> <a href="#" title="Doctor Strange in  the Multiverse of Madness"> <img class="small-image" src="newImages/ComingSoon/Doctor_strange.jpg" alt="Doctor Strange in  the Multiverse of Madness" title="Doctor Strange in the Multiverse of Madness"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="#" title="Doctor Strange in the Multiverse of Madness">Doctor Strange in the Multiverse of Madness</a></h2>
              <div class="desc std">
          ...
          <li class="item even">
            <div class="product-image"> <a href="#" title="Obi-Wan Kenobi"> <img class="small-image" src="newImages/ComingSoon/kenobiedited.jpg" alt="Obi-Wan Kenobi" title="Obi-Wan Kenobi"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="#" title="Obi-Wan Kenobi">Obi-Wan Kenobi</a></h2>
              <div class="desc std">
          ...
          <li class="item odd">
            <div class="product-image"> <a href="#" title="The Bad Batch"> <img class="small-image" src="newImages/ComingSoon/TheBadBatch.jpg" alt="The Bad Batch" title="The Bad Batch"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="#" title="The Bad Batch">The Bad Batch</a></h2>
              <div class="desc std">
          ...
          <li class="item even">
            <div class="product-image"> <a href="#" title="Ahsoka"> <img class="small-image" src="newImages/ComingSoon/Ahsoka.jpg" alt="Ahsoka" title="Ahsoka"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="#" title="Ahsoka">Ahsoka</a></h2>
              <div class="desc std">
          ...
          <li class="item odd">
            <div class="product-image"> <a href="#" title="Sonic the Hedgehog 2"> <img class="small-image" src="newImages/ComingSoon/sonicthehedgehog2.jpg" alt="Sonic the Hedgehog 2" title="Sonic the Hedgehog 2"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="#" title="Sonic the Hedgehog 2">Sonic the Hedgehog 2</a></h2>
              <div class="desc std">
          ...
          <li class="item even">
            <div class="product-image"> <a href="#" title="Joker"> <img class="small-image" src="newImages/ComingSoon/JohnWick4.jpg" alt="John Wick Chapter 4" title="John Wick Chapter 4"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="#" title="John Wick Chapter 4">John Wick Chapter 4</a></h2>
              <div class="desc std">
          ...
          <li class="item last even">
            <div class="product-image"> <a href="#" title="Beauty and The Beast"> <img class="small-image" src="newImages/ComingSoon/JurassicWorldDominion.jpg" alt="Jurassic World Dominion" title="Jurassic World Dominion"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="#" title="Jurassic World Dominion">Jurassic World Dominion</a></h2>
             <!-- <div class="ratings">
                <div class="rating-box">
